...
public class FeatureEngineer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //basic feature
        JavaRDD<Feature> feature1 = scores
        ...
        //下面获得user_embedding video_embedding
        ...
        System.out.println("embedding length = " + indexmap.size());
        ...
        //合并
        JavaRDD<Feature> feature2 = feature1
                .mapToPair(feature -> new Tuple2<>(feature.videoid, feature))   //关联user
                .join(videofeatures)
                .values()
                .map(tuple -> {
                ...
                .mapToPair(feature -> new Tuple2<>(feature.userid, feature))    //关联video
                .join(userfeatures)
                .values()
                .map(tuple -> {
...
//        dataFrame.printSchema();
        ...
        OneHotEncoder oneHotEncoder = new OneHotEncoder()   //secondlevel转为onehot
                ...
                .setDropLast(false);
        String[] vectorAsCols =
                {"content_type_vector", "watchnum", "user_e", "video_e"};
...
//        newfeature.printSchema();
    ...
    private static JavaPairRDD<Long, double[]> generate_video_embedding_all(HashMap<String, Integer> indexmap) {
        return videopair.mapValues(video -> {
            //创建一个空的onehot
